...
#     amrdata.refinement_ratios_t = [10,10,50]
   ...
   # For Mel_s_b
    regions.append([1, 4, 0., 1.e10,   (2500-15)*1000., (2500.5)*1000.,   (5000-17)*1000., (5000-9)*1000.]) # area around barrier island
...
#             gauge_num+=1
   ...
   # For Mel_s_b
    ...
    gauge_points = np.array([[(5000-30)*1000+15700,(5000-30)*1000+16300,(5000-30)*1000+19800,(5000-30)*1000+24300,(5000-30)*1000+29800,(5000-30)*1000+18000,
                              (5000-30)*1000+24300,(5000-30)*1000+24300,(5000-30)*1000+24300,(5000-30)*1000+16300],
                         [2492.5*1000,2492.5*1000,2492.5*1000,2492.5*1000,2492.5*1000,2492.5*1000,2500*1000,(2500-1.5)*1000,(2500+1.5)*1000,(2500+7.5)*1000]])

...
#     amrdata.refinement_ratios_t = [10,10,50]
   ...
   # For Mel_s_b
    regions.append([3, 4, 0., 1.e10,   (2500-15)*1000., (2500.5)*1000.,   (5000-17)*1000., (5000-9)*1000.]) # area around barrier island
#     regions.append([3, 4, 0., 1.e10,   (2500-7)*1000., (2500.5)*1000.,   (5000-17)*1000., (5000)*1000.]) # area around bay
...
#             gauge_num+=1
   ...
   # For Mel_s_b
    import numpy as np
    gauge_points = np.array([[(5000-30)*1000+15700,(5000-30)*1000+16300,(5000-30)*1000+19800,(5000-30)*1000+24300,(5000-30)*1000+29800,
                          (5000-30)*1000+18000,(5000-30)*1000+18000,(5000-30)*1000+18000,(5000-30)*1000+18000,
                          (5000-30)*1000+24300,(5000-30)*1000+24300],
                         [(2500-4)*1000,2500*1000,(2500)*1000,2500*1000,2500*1000,
                          (2500)*1000,(2500-2)*1000,(2500-4)*1000,(2500-6)*1000,
...
#     topo_data.topofiles.append([3, topo_coarse_path])
    ...
    # Mel_s_nb_3_m.txt
    topo_hydro_dir = '/home/jovyan/data/topo_files_output/'
    topo_fine_path = os.path.join(topo_hydro_dir, 'Mel_s_nb_30_m.txt')
#    topo_fine_path_30 = os.path.join(topo_hydro_dir, 'Sav_s_b_30_m.txt')
    topo_coarse_path = os.path.join(topo_hydro_dir, 'Mel_s_nb_coarse_m.txt')
    topo_data.topofiles.append([3, topo_fine_path])
#    topo_data.topofiles.append([3, topo_fine_path_30])
    topo_data.topofiles.append([3, topo_coarse_path])
